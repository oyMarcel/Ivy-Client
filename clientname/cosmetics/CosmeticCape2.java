...
/*    */   
/*    */   public CosmeticCape2(RenderPlayer playerRendererIn) {
/* 19 */     this.playerRenderer = playerRendererIn;
/*    */   }
/*    */ 
/*    */   
/*    */   public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
/* 24 */     if (Client.CosmeticCape2 && entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE) && entitylivingbaseIn.getName().equals(Minecraft.getMinecraft().getSession().getUsername())) {
/* 25 */       GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
/* 26 */       this.playerRenderer.bindTexture(new ResourceLocation("Cape2.png"));
