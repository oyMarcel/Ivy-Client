...
/* 24 */     if (Client.CosmeticCape && entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE) && entitylivingbaseIn.getName().equals(Minecraft.getMinecraft().getSession().getUsername())) {
/* 25 */       GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
/* 26 */       this.playerRenderer.bindTexture(new ResourceLocation(Client.Cape));
